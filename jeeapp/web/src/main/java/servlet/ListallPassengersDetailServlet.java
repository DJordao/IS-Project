...
@WebServlet("/secured/listallPassengersdetail")
public class ListallPassengersDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        List<BusTrip> bt = (List<BusTrip>) request.getSession().getAttribute("detailedTrip");
